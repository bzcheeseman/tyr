...
bool tyr::pass::RustCodegenPass::runOnModule(tyr::Module &m) {
  ...
  // Need the full path to the object file
  ...
  // Need the full path to the bitcode file
  ...
  out << "extern crate bindgen;\n"
         ...
         "\n";
  out << "#[allow(dead_code)]\n";
  out << "pub fn " << RustBuildFunctionName << "_object() {\n"
      ...
      << "    let bindings = bindgen::Builder::default()\n"
         "        .header(\""
      << CHeaderName << "\")\n"
      << "        .clang_arg(\"-I" << TYR_INSTALL_PATH << "/include\")\n"
      << "        .generate()\n"
  ...
  out << "#[allow(dead_code)]\n";
  out << "pub fn " << RustBuildFunctionName << "_llvm() {\n"
      << "    println!(\"cargo:rustc-link-lib=" << m.getModule()->getName()
      << "\");\n"
      << "    cc::Build::new()\n"
         "        .file(\""
